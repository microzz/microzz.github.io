...
console.log("%c 目前是一个待业的大三码农,求工作(＾_＾)","background-image:-webkit-gradient( linear, left top,right top, color-stop(0, #3bfc31), color-stop(0.15, #00695C), color-stop(0.3, #AA00FF),color-stop(0.4, #8BC34A), color-stop(0.45, #607D8B),color-stop(0.6, #4096EE), color-stop(0.75, #D50000),color-stop(0.9, #4096EE), color-stop(1, #FF1A00));color:transparent;-webkit-background-clip:text;font-size:13px;");

...
![Git microzz.com](https://icdn.microzz.com/20170506_git/git.jpg)
...
克隆版本库的时候，所使用的远程主机自动被Git命名为origin。如果想用其他的主机名，需要用`git clone`命令的-o选项指定。

---
title: JavaScript中的RegExp对象
date: 2017-08-26 10:04:05
tags:
 - JS
 - JavaScript
 - RegExp
...
上面代码表示，字符串“hello world”不包含`a`、`b`、`c`这三个字母中的任一个，而字符串“”包含字母`a`。
...
## 关于
本文仅供学习交流分享，原文链接 [RegExp对象](http://javascript.ruanyifeng.com/stdlib/regexp.html)，感谢阮一峰老师
